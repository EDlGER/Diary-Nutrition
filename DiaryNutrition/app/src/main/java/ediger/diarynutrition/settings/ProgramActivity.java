        ...
        spMacro.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    unitProt.setText(getString(R.string.diary_list_gram));
                    unitFat.setText(getString(R.string.diary_list_gram));
                    unitCarbo.setText(getString(R.string.diary_list_gram));
