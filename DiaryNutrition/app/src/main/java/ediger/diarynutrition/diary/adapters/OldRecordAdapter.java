...
//TODO Remove
public class OldRecordAdapter extends CursorTreeRecyclerAdapter<OldRecordAdapter.MyGroupViewHolder, OldRecordAdapter.MyChildViewHolder> {
    ...
    public static class MyGroupViewHolder extends AbstractExpandableItemViewHolder {
        ...
        public MyGroupViewHolder(View v) {
            ...
            //group_serv was commented
            mServing = v.findViewById(R.id.txt_meal);
    ...
    public OldRecordAdapter(Context context, DiaryFragment fragment, Cursor cursor) {
