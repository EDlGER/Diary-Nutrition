...
public class MultiShrinkScroller extends FrameLayout {
    ...
    private MultiShrinkScroller.MultiShrinkScrollerListener listener;
    ...
    private final AnimatorListener exitAnimationListner = new AnimatorListenerAdapter() {
        ...
        public void onAnimationEnd(Animator animation) {
            if ((getScrollUntilOffBottom() > 0 || openAnimation == MultiShrinkScroller.OpenAnimation.EXPAND_FROM_VIEW) && listener != null) {
     ...
     */
    public void initialize(MultiShrinkScroller.MultiShrinkScrollerListener listener, boolean isOpenContactSquare) {
    ...
    public boolean willUseReverseExpansion() {
        return openAnimation == MultiShrinkScroller.OpenAnimation.EXPAND_FROM_VIEW && hasEverTouchedTheTop;
    }
    ...
    public void scrollOffBottom() {
        ...
        if (!willUseReverseExpansion()) {
            final Interpolator interpolator = new MultiShrinkScroller.AcceleratingFlingInterpolator(
     ...
     * screen.
     */
    public void performEntranceAnimation(MultiShrinkScroller.OpenAnimation animation, boolean scrollToCurrentPosition) {
        ...
        if (animation ==MultiShrinkScroller.OpenAnimation.EXPAND_FROM_VIEW) {
